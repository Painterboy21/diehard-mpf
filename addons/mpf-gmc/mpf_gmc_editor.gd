...
func _enter_tree():
	...
	add_custom_type("MPFRandomVideoPlayer", "VideoStreamPlayer", preload("classes/mpf_random_video_player.gd"), preload("icons/VideoStreamPlayer.svg"))
...
func _exit_tree():
	...
	remove_custom_type("MPFRandomVideoPlayer")
